...
MAKECMD         = /Applications/MATLAB_R2023a.app/bin/maci64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = Fl
MODULES                 = Fl_sf.c Fl_sf_data.c rtGetInf.c rtGetNaN.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/Fl_sf.mexmaci64
MAKEFILE                = Fl.mk
MATLAB_ROOT             = /Applications/MATLAB_R2023a.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2023a.app
START_DIR               = /Users/proto/Library/CloudStorage/Dropbox/HSD_Nextcloud/Lehrveranstaltungen/Sommersemester/Modellbildung_Simulation/github/modellbildung_simulation/stateflow_python
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 2
COMPUTER                = MACI64
BUILDARGS               =  CREATEMODEL=1 USEPARAMVALUES=0 OPTS="-DTID01EQ=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=10.15"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = -L"/Applications/MATLAB_R2023a.app/bin/maci64" -lut -lfixedpoint -lmx -lmex
...
Fl_sf.o : $(START_DIR)/Fl_sfcn_rtw/Fl_sf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/Fl_sfcn_rtw/Fl_sf.c

Fl_sf_data.o : $(START_DIR)/Fl_sfcn_rtw/Fl_sf_data.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/Fl_sfcn_rtw/Fl_sf_data.c

rtGetInf.o : $(START_DIR)/Fl_sfcn_rtw/rtGetInf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/Fl_sfcn_rtw/rtGetInf.c

rtGetNaN.o : $(START_DIR)/Fl_sfcn_rtw/rtGetNaN.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/Fl_sfcn_rtw/rtGetNaN.c
