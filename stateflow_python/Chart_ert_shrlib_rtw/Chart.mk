###########################################################################
## Makefile generated for component 'Chart'. 
## 
## Makefile     : Chart.mk
## Generated on : Fri May 24 21:02:57 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Chart.dylib
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Chart.dylib
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Chart_ert_shrlib_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Chart -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Chart_ert_shrlib_rtw/Chart.c

MAIN_SRC = $(START_DIR)/Chart_ert_shrlib_rtw/ert_main.c
...
%.o : $(START_DIR)/Chart_ert_shrlib_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Chart_ert_shrlib_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Chart.o : $(START_DIR)/Chart_ert_shrlib_rtw/Chart.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Chart_ert_shrlib_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
